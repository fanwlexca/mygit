...
void* qemu_get_phys_ram_ptr(ram_addr_t paddr)  //[fwl]for S2EExecutionState.cpp
{
...
static void notdirty_mem_writeb(void *opaque, target_phys_addr_t ram_addr,
                                uint32_t val)  //different from indroid0.2
{
    int dirty_flags;
...
int s2e_ismemfunc(void *f)  //[fwl]different from s2e1.2
{
...
#ifdef CONFIG_S2E  //[fwl]different from s2e1.2
